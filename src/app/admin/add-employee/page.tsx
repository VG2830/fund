        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
             ...
             <div > <Button type="submit" className="text-white mr-4 bg-[#1e88e5]">Add Employee</Button>
             <Button type="submit" className="text-white bg-[#1e88e5]">Update Employee</Button>
             </div>
            </form>
          </Form>
        </CardContent>
